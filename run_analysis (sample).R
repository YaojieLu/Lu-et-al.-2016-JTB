...
ca1 <- 400  # Atmospheric CO2 concentration (ppm)
k1 <- 0.05 # Rainfall frequency (per day)
MAP <- 1825 # MAP=MDP*365; MAP: mean annual precipitation; MDP: mean daily precipitation
...
write.csv(res, "Derived variables (sample).csv", row.names = FALSE)
